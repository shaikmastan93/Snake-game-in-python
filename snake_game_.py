...
pygame.display.set_caption("Mastan game")
...
def gameLoop():
    ...
    # this statement generate food random
    ...
    while not game_over:
        ...
        snake_Head = []
        snake_Head.append(x1)  # increase snake on the x-axis
        snake_Head.append(y1)  # increasing snake on the y-axis
